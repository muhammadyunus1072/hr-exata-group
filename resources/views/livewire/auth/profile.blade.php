<form wire:submit="store">
    <div class="row">
        <div class="col-md-6 mb-3">
            ...
            <p class="form-control">{{$nomor_karyawan}}</p>
        </div>
    </div>
    <ul class="nav nav-tabs" id="tabEmployee" role="tablist" wire:ignore>
        <li class="nav-item" role="presentation">
            <button class="nav-link active" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="true"><h3>Profile</h3></button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="personal-tab" data-bs-toggle="tab" data-bs-target="#personal-tab-pane" type="button" role="tab" aria-controls="personal-tab-pane" aria-selected="true"><h3>Personal</h3></button>
        </li>
        <li class="nav-item" role="presentation">
    ...
    <div class="tab-content" id="tabEmployeeContent" wire:ignore.self>
        ...
        <div wire:ignore.self class="tab-pane fade" id="personal-tab-pane" role="tabpanel" aria-labelledby="personal-tab" tabindex="0">
            <div class="row">
